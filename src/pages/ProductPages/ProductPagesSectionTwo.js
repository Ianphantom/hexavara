...
const ProductPagesSectionTwo = () => {
  return (
    <ProductPagesSectionTwoStyled className='container'>
      <div className='title text-center heading-large'>Build Trust</div>
    ...
    </ProductPagesSectionTwoStyled>
  );
};

const ProductPagesSectionTwoStyled = styled.div`
  .title {
    margin-bottom: 12px;
...
export default ProductPagesSectionTwo;
